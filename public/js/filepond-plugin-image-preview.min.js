...
!(function(e, t) {
  ...
  "use strict";
  var e = { type: "spring", stiffness: 0.5, damping: 0.45, mass: 10 },
    t = function(e, t) {
      return { x: e, y: t };
    },
    i = function(e, i) {
    ...
    r = function(e, i) {
      var a = e,
        ...
        h = Math.cos(n),
        l = a / o;
      return t(h * (l * c), h * (l * s));
    },
    n = function(e, i, n, o) {
      var c = o.x > 0.5 ? 1 - o.x : o.x,
        s = o.y > 0.5 ? 1 - o.y : o.y,
        h = 2 * c * e.width,
        l = 2 * s * e.height,
        f = (function(e, i) {
          var n = e.width,
            ...
            c = r(n, i),
            s = r(o, i),
            h = t(e.x + Math.abs(c.x), e.y - Math.abs(c.y)),
            l = t(e.x + e.width + Math.abs(s.y), e.y + Math.abs(s.x)),
            f = t(e.x - Math.abs(s.y), e.y + e.height - Math.abs(s.x));
          return { width: a(h, l), height: a(h, f) };
        })(i, n);
      return Math.max(f.width / h, f.height / l);
    },
    o = function(t) {
      return t.utils.createView({
        ...
        create: function(i) {
                ...
                return t.utils.createView({
                  ...
                  write: function(e) {
                    var t = e.root,
                      i = e.props.crop.flip,
                      a = t.ref.bitmap;
                    (a.scaleX = i.horizontal ? -1 : 1),
                      (a.scaleY = i.vertical ? -1 : 1);
                  }
                });
              })(t),
              Object.assign({}, r)
          ...
          var n = a.query("GET_IMAGE_PREVIEW_TRANSPARENCY_INDICATOR");
          null !== n &&
            (a.element.dataset.transparencyIndicator =
              "grid" === n ? n : "color");
        },
        write: function(e) {
          var t = e.root,
          ...
          var s = {
              ...
              width: o,
              height: c,
              center: { x: 0.5 * o, y: 0.5 * c }
            },
            h = { width: t.ref.image.width, height: t.ref.image.height },
            l = { x: r.center.x * h.width, y: r.center.y * h.height },
            f = {
              x: s.center.x - h.width * r.center.x,
              y: s.center.y - h.height * r.center.y
            },
            u = 2 * Math.PI + (r.rotation % (2 * Math.PI)),
            d = r.aspectRatio || h.height / h.width,
            g = n(
              h,
              (function(e, t) {
                var i = e.width,
      ...
      self.onmessage = function(e) {
        for (
          ...
          (R = a[A] / 255),
            ...
            (a[A] = Math.max(
              0,
              Math.min(255 * (R * n + D * o + P * c + G * s + h), 255)
            )),
            (a[A + 1] = Math.max(
              0,
              Math.min(255 * (R * l + D * f + P * u + G * d + g), 255)
            )),
            (a[A + 2] = Math.max(
              0,
              Math.min(255 * (R * p + D * E + P * m + G * _ + I), 255)
            )),
            (a[A + 3] = Math.max(
              0,
              Math.min(255 * (R * v + D * w + P * y + G * M + T), 255)
            ));
    ...
    d = function(e, t, i, a) {
      ...
      return (
        (function(e, t, i, a) {
          -1 !== a && e.transform.apply(e, u[a](t, i));
        })(n, t, i, a),
    ...
    p = function(e) {
      var t = Math.min(10 / e.width, 10 / e.height),
        ...
        a = i.getContext("2d"),
        r = (i.width = Math.ceil(e.width * t)),
        n = (i.height = Math.ceil(e.height * t));
      a.drawImage(e, 0, 0, r, n);
      var o = null;
      try {
        o = a.getImageData(0, 0, r, n).data;
      } catch (e) {
        return null;
      }
      for (var c = o.length, s = 0, h = 0, l = 0, f = 0; f < c; f += 4)
        (s += o[f] * o[f]),
          (h += o[f + 1] * o[f + 1]),
          (l += o[f + 2] * o[f + 2]);
      return { r: (s = E(s, c)), g: (h = E(h, c)), b: (l = E(l, c)) };
    },
    E = function(e, t) {
      ...
      var i = t.utils.createView({
          ...
          create: function(e) {
            ...
            !s &&
              ...
              (t.element.innerHTML = c.replace(/__UID__/g, h));
          },
          mixins: {
            styles: ["opacity"],
          ...
          return t.utils.createView({
            ...
            create: function(e) {
              ...
              i.ref.clip = i.appendChildView(
                i.createChildView(o(t), { image: a.image, crop: a.crop })
              );
            },
            write: function(e) {
              var t = e.root,
              ...
              if (
                ...
                var c = o.height / o.width,
                  ...
                  l = t.rect.inner.height,
                  f = t.query("GET_IMAGE_PREVIEW_HEIGHT"),
                  u = t.query("GET_IMAGE_PREVIEW_MIN_HEIGHT"),
                  d = t.query("GET_IMAGE_PREVIEW_MAX_HEIGHT"),
                  g = t.query("GET_PANEL_ASPECT_RATIO"),
                  p = t.query("GET_ALLOW_MULTIPLE");
                g && !p && ((f = h * g), (s = g));
                var E = null !== f ? f : Math.max(u, Math.min(h * s, d)),
                  m = E / s;
                m > h && (E = (m = h) * s),
                  E > l && ((E = l), (m = l / s)),
                  (r.width = m),
        ...
        create: function(e) {
          ...
          (t.ref.images = []),
            ...
            (t.ref.overlayShadow = t.appendChildView(
              t.createChildView(i, { opacity: 0, status: "idle" })
            )),
            (t.ref.overlaySuccess = t.appendChildView(
              t.createChildView(i, { opacity: 0, status: "success" })
            )),
            (t.ref.overlayError = t.appendChildView(
              t.createChildView(i, { opacity: 0, status: "failure" })
            ));
        },
        styles: ["height"],
        apis: ["height"],
        ...
        write: t.utils.createRoute(
          {
              ...
              if (o) {
                var c,
                  ...
                  f = function(e) {
                    ...
                    var a = (o.getMetadata("exif") || {}).orientation || -1,
                      r = e.width,
                      c = e.height;
                    if (a >= 5 && a <= 8) {
                      var h = [c, r];
                    ...
                    var l = Math.max(1, 0.75 * window.devicePixelRatio),
                      f = t.query("GET_IMAGE_PREVIEW_ZOOM_FACTOR") * l,
                      g = c / r,
                      E = t.rect.element.width,
                      m = t.rect.element.height,
                      _ = E,
                      I = _ * g;
                    g > 1
                      ? (I = (_ = Math.min(r, E * f)) * g)
                      : (_ = (I = Math.min(c, m * f)) / g);
                    var v = d(e, _, I, a),
                      w = function() {
                        var a = t.query(
                          ...
                          ? p(data)
                          : null;
                        o.setMetadata("color", a, !0),
                          "close" in e && e.close(),
                          (t.ref.overlayShadow.opacity = 1),
                          u({ root: t, props: i, image: v });
                      },
                      y = o.getMetadata("filter");
                    y ? n(t, y, v).then(w) : w();
                  };
                if (((c = o.file), "createImageBitmap" in window && g(c))) {
                  var E = r(l);
                  E.post({ file: o.file }, function(e) {
                    E.terminate(), e ? f(e) : h();
                  });
                } else h();
              }
            ...
            DID_UPDATE_ITEM_METADATA: function(e) {
              var t = e.root,
                i = e.props,
                a = e.action;
              if (/crop|filter/.test(a.change.key) && t.ref.images.length) {
                var r = t.query("GET_ITEM", { id: i.id });
                if (r)
                  if (/filter/.test(a.change.key)) {
                    var o = t.ref.images[t.ref.images.length - 1];
                    n(t, a.change.value, o.image);
                  } else {
                    if (/crop/.test(a.change.key)) {
                      var c = r.getMetadata("crop"),
                        s = t.ref.images[t.ref.images.length - 1];
                      if (Math.abs(c.aspectRatio - s.crop.aspectRatio) > 1e-5) {
                        var h = (function(e) {
                          var t = e.root,
                        ...
                        u({
                          ...
                          props: i,
                          image: ((l = h.image),
                          ((f = f || document.createElement("canvas")).width =
                            l.width),
                          (f.height = l.height),
                        ...
                        !(function(e) {
                          var t = e.root,
                            i = e.props,
                            a = t.query("GET_ITEM", { id: i.id });
                          a &&
                            (t.ref.images[
                              t.ref.images.length - 1
                            ].crop = a.getMetadata("crop"));
                        })({ root: t, props: i });
                    }
                    var l, f;
                  }
      ...
      return (
        t("CREATE_VIEW", function(e) {
          var t = e.is,
            i = e.view,
            a = e.query;
          if (t("file") && a("GET_ALLOW_IMAGE_PREVIEW")) {
            var c = function(e) {
                    ...
                    if (c && n(c.file) && !c.archived) {
                      ...
                      if (
                        ...
                        var h = "createImageBitmap" in (window || {}),
                          l = a("GET_IMAGE_PREVIEW_MAX_FILE_SIZE");
                        if (!(!h && l && s.size > l)) {
                          t.ref.imagePreview = i.appendChildView(
                            i.createChildView(o, { id: r })
                          );
                          var f = t.query("GET_IMAGE_PREVIEW_HEIGHT");
                          f &&
                    ...
                    (t.ref.shouldRescale &&
                      (!(function(e, t) {
                        if (e.ref.imagePreview) {
                          ...
                          if (a) {
                            var r = e.query("GET_PANEL_ASPECT_RATIO"),
                            ...
                            if (!(r || n || o)) {
                              var c = e.ref,
                                ...
                                h = c.imageHeight;
                              if (s && h) {
                                var l = e.query("GET_IMAGE_PREVIEW_MIN_HEIGHT"),
                                ...
                                var E = h / s,
                                  m =
                                    (a.getMetadata("crop") || {}).aspectRatio ||
                                    E,
                                  _ = Math.max(l, Math.min(h, f)),
  ...
  return (
    "undefined" != typeof window &&
      ...
      document.dispatchEvent(
        new CustomEvent("FilePond:pluginloaded", { detail: _ })
      ),
    _
  );
});
