...
!(function(e, t) {
  ...
  var t,
    ...
    s = function(e, t) {
      ...
      return (
        t && (u(e) ? i(o, "class", t) : (o.className = t)),
        r(n, function(e, t) {
          i(o, e, t);
        }),
        o
        ...
        var e =
          ...
          p = o({
            interpolate: function() {
              if (!f) {
                if (!E(s) || !E(l)) return (f = !0), void (c = 0);
                !(function(e, t, n) {
                  var r =
            ...
            target: {
              set: function(e) {
                if (
                  ...
                  return (f = !0), (c = 0), p.onupdate(l), void p.oncomplete(l);
                f = !1;
              },
              get: function() {
                return s;
        ...
        var e,
          ...
          E = o({
            ...
            target: {
              ...
              set: function(e) {
                if (null === d)
                  return (d = e), E.onupdate(e), void E.oncomplete(e);
                e < d ? ((d = 1), (p = !0)) : ((p = !1), (d = e)),
                  (f = !1),
                  (c = null);
              }
    ...
    h = function(e, t) {
      var n = t.opacity,
        ...
        T = "";
      (v(f) || v(p)) &&
        (T += "transform-origin: " + (f || 0) + "px " + (p || 0) + "px;"),
        v(r) && (_ += "perspective(" + r + "px) "),
        (v(o) || v(i)) &&
          (_ += "translate3d(" + (o || 0) + "px, " + (i || 0) + "px, 0) "),
        (v(a) || v(u)) &&
          (_ += "scale3d(" + (v(a) ? a : 1) + ", " + (v(u) ? u : 1) + ", 1) "),
        v(c) && (_ += "rotateZ(" + c + "rad) "),
        v(s) && (_ += "rotateX(" + s + "rad) "),
        v(l) && (_ += "rotateY(" + l + "rad) "),
        ...
        return (
          ...
          }),
          {
            write: function() {
              if (R(u, n))
                return (
                  h(i.element, n), Object.assign(u, Object.assign({}, n)), !0
                );
            },
            destroy: function() {}
          }
    ...
    y = function() {
      ...
      return function(e) {
        var t,
          ...
          a = s(n, "filepond--" + i, u),
          p = window.getComputedStyle(a, null),
          E = D(),
          T = null,
          m = !1,
          g = [],
          ...
          F = Object.assign({}, V, {
            ...
            appendChildView: l(0, g),
            removeChildView: c(a, g),
          ...
          q = {
            ...
            _read: function() {
              (T = null),
                ...
                !(M && E.width && E.height) && D(E, a, p);
              var e = { root: Y, props: r, rect: E };
              ...
              return (
                ...
                g.forEach(function(r, i) {
                  r.element.parentNode ||
                    (Y.appendChild(r.element, i),
                    r._read(),
                    r._write(e, R(r, t), n),
                    (o = !1));
                }),
                (m = o),
                A({ props: r, root: Y, actions: t, timestamp: e }),
                o
              );
            },
            _destroy: function() {
    ...
    U = function(e) {
      return E(e) ? e : G(e) ? C(e).replace(/[a-z]+/gi, "") : 0;
    },
    B = function(e) {
    ...
    q = function(e) {
      ...
      var t = C(e).trim();
      return /MB$/i.test(t)
        ? ((t = t.replace(/MB$i/, "").trim()), 1e3 * B(t) * 1e3)
        : /KB/i.test(t)
        ? ((t = t.replace(/KB$i/, "").trim()), 1e3 * B(t))
        : B(t);
    },
    x = function(e) {
    ...
    j = function(e, t, n, r) {
      ...
      if (G(t)) return (o.url = t), o;
      if ((Object.assign(o, t), G(o.headers))) {
        ...
        return (
          r(e, function(e) {
            ...
            i["SET_" + n] = function(r) {
              ...
              t("DID_SET_" + n, { value: o.options[e] });
            };
          }),
          i
        );
    ...
    ve = {
      id: [null, de.STRING],
      name: ["filepond", de.STRING],
      disabled: [!1, de.BOOLEAN],
      className: [null, de.STRING],
      required: [!1, de.BOOLEAN],
      captureMethod: [null, de.STRING],
      allowDrop: [!0, de.BOOLEAN],
      allowBrowse: [!0, de.BOOLEAN],
      allowPaste: [!0, de.BOOLEAN],
      allowMultiple: [!1, de.BOOLEAN],
      allowReplace: [!0, de.BOOLEAN],
      allowRevert: [!0, de.BOOLEAN],
      forceRevert: [!1, de.BOOLEAN],
      maxFiles: [null, de.INT],
      checkValidity: [!1, de.BOOLEAN],
      itemInsertLocationFreedom: [!0, de.BOOLEAN],
      itemInsertLocation: ["before", de.STRING],
      itemInsertInterval: [75, de.INT],
      dropOnPage: [!1, de.BOOLEAN],
      dropOnElement: [!0, de.BOOLEAN],
      dropValidation: [!1, de.BOOLEAN],
      ignoredFiles: [[".ds_store", "thumbs.db", "desktop.ini"], de.ARRAY],
      instantUpload: [!0, de.BOOLEAN],
      maxParallelUploads: [2, de.INT],
      server: [null, de.SERVER_API],
      labelDecimalSeparator: [pe(), de.STRING],
      labelThousandsSeparator: [
        ((t = pe()),
        (n = (1e3).toLocaleString()),
        n !== (1e3).toString() ? fe(n)[0] : "." === t ? "," : "."),
        de.STRING
      ],
      labelIdle: [
      ...
      labelInvalidField: ["Field contains invalid files", de.STRING],
      labelFileWaitingForSize: ["Waiting for size", de.STRING],
      labelFileSizeNotAvailable: ["Size not available", de.STRING],
      labelFileCountSingular: ["file in list", de.STRING],
      labelFileCountPlural: ["files in list", de.STRING],
      labelFileLoading: ["Loading", de.STRING],
      labelFileAdded: ["Added", de.STRING],
      labelFileLoadError: ["Error during load", de.STRING],
      labelFileRemoved: ["Removed", de.STRING],
      labelFileRemoveError: ["Error during remove", de.STRING],
      labelFileProcessing: ["Uploading", de.STRING],
      labelFileProcessingComplete: ["Upload complete", de.STRING],
      labelFileProcessingAborted: ["Upload cancelled", de.STRING],
      labelFileProcessingError: ["Error during upload", de.STRING],
      labelFileProcessingRevertError: ["Error during revert", de.STRING],
      labelTapToCancel: ["tap to cancel", de.STRING],
      labelTapToRetry: ["tap to retry", de.STRING],
      labelTapToUndo: ["tap to undo", de.STRING],
      labelButtonRemoveItem: ["Remove", de.STRING],
      labelButtonAbortItemLoad: ["Abort", de.STRING],
      labelButtonRetryItemLoad: ["Retry", de.STRING],
      labelButtonAbortItemProcessing: ["Cancel", de.STRING],
      labelButtonUndoItemProcessing: ["Undo", de.STRING],
      labelButtonRetryItemProcessing: ["Retry", de.STRING],
      labelButtonProcessItem: ["Upload", de.STRING],
      iconRemove: [
      ...
      oninit: [null, de.FUNCTION],
      onwarning: [null, de.FUNCTION],
      onerror: [null, de.FUNCTION],
      onactivatefile: [null, de.FUNCTION],
      onaddfilestart: [null, de.FUNCTION],
      onaddfileprogress: [null, de.FUNCTION],
      onaddfile: [null, de.FUNCTION],
      onprocessfilestart: [null, de.FUNCTION],
      onprocessfileprogress: [null, de.FUNCTION],
      onprocessfileabort: [null, de.FUNCTION],
      onprocessfilerevert: [null, de.FUNCTION],
      onprocessfile: [null, de.FUNCTION],
      onprocessfiles: [null, de.FUNCTION],
      onremovefile: [null, de.FUNCTION],
      onpreparefile: [null, de.FUNCTION],
      onupdatefiles: [null, de.FUNCTION],
      beforeDropFile: [null, de.FUNCTION],
      beforeAddFile: [null, de.FUNCTION],
      beforeRemoveFile: [null, de.FUNCTION],
      stylePanelLayout: [null, de.STRING],
      stylePanelAspectRatio: [null, de.STRING],
      styleItemPanelAspectRatio: [null, de.STRING],
      styleButtonRemoveItemPosition: ["left", de.STRING],
      styleButtonProcessItemPosition: ["right", de.STRING],
      styleLoadIndicatorPosition: ["right", de.STRING],
      styleProgressIndicatorPosition: ["right", de.STRING],
      files: [[], de.ARRAY]
    },
    ge = function(e, t) {
      return P(t)
    ...
    Oe = { EMPTY: 0, IDLE: 1, ERROR: 2, BUSY: 3, READY: 4 },
    De = [le.LOAD_ERROR, le.PROCESSING_ERROR, le.PROCESSING_REVERT_ERROR],
    ye = [le.LOADING, le.PROCESSING, le.PROCESSING_QUEUED, le.INIT],
    ...
    Pe = function(e) {
      return {
        ...
        GET_ACTIVE_ITEM: function(t) {
          return ge(he(e.items), t);
        },
        GET_ACTIVE_ITEMS: function(t) {
          return he(e.items);
        },
        ...
        GET_PANEL_ASPECT_RATIO: function() {
          return /circle/.test(e.options.stylePanelLayout)
            ? 1
            : Re(e.options.stylePanelAspectRatio);
        },
        GET_ITEM_PANEL_ASPECT_RATIO: function() {
          return e.options.styleItemPanelAspectRatio;
        },
        GET_ITEMS_BY_STATUS: function(t) {
          return he(e.items).filter(function(e) {
            return e.status === t;
          });
        },
        GET_TOTAL_ITEMS: function() {
          return he(e.items).length;
        },
        IS_ASYNC: function() {
          return (
            H(e.options.server) &&
            (H(e.options.server.process) || x(e.options.server.process))
          );
        }
      };
    },
              ...
              (t.request = e(
                ...
                function(e) {
                  (t.duration = Date.now() - t.timestamp),
                    (t.complete = !0),
                    e instanceof Blob && (e = Be(e, Ne(n))),
                    r.fire("load", e instanceof Blob ? e : e.body);
                },
                function(e) {
                  r.fire(
                    "error",
          ...
          load: function() {
            ...
            r.fire("init", i),
              i instanceof File
                ? r.fire("load", i)
                : i instanceof Blob
                ? r.fire("load", Be(i, i.name))
                : Ce(i)
                ? r.fire("load", Be(qe(i), e, null, o))
                : n(i);
          }
        });
      return r;
    ...
    ze = function(e, t, n) {
      ...
      return (
        ((We(n.method) ? a : a.upload).onprogress = function(e) {
        ...
        return (
          (c.onload = function(e) {
            var t = e.getAllResponseHeaders(),
              r = He(t).name || Ne(o);
            i(ke("load", e.status, Be(n(e.response), r), t));
          }),
          ...
          (c.onheaders = function(e) {
            l(ke("headers", e.status, null, e.getAllResponseHeaders()));
          }),
          (c.ontimeout = Qe(a)),
          (c.onprogress = u),
          (c.onabort = s),
    ...
    $e = function() {
      ...
      return function(o, i, a) {
        var u = ze(o, e + t.url, t);
        return (
          (u.onload = function(e) {
            i(ke("load", e.status, n(e.response), e.getAllResponseHeaders()));
          }),
            ...
            r.fire("start"),
              ...
              (t.perceivedPerformanceUpdater = (function(e) {
                ...
                (t.perceivedProgress = e),
                  ...
                  i(),
                  t.response && 1 === t.perceivedProgress && !t.complete && a();
              }, Ke(750, 1500))),
              (t.request = e(
                n,
                o,
                ...
                function() {
                  t.perceivedPerformanceUpdater.clear(),
                    r.fire("abort", t.response ? t.response.body : null);
                }
              ));
          },
          abort: n,
        ...
        c = function(e, t, n) {
          ...
          r.forEach(function(e) {
            ...
            JSON.stringify(a[i]) !== JSON.stringify(t) &&
              ((a[i] = t), n || l("metadata-update", { key: o, value: u[o] }));
        },
        f = Object.assign(
          {
            id: {
            ...
            filenameWithoutExtension: {
              get: function() {
                return et(i.file.name);
              }
            },
            fileExtension: {
              get: function() {
                return we(i.file.name);
              }
            },
            fileType: {
              get: function() {
              ...
              (i.source = t),
                i.file
                  ...
                  : ((i.file = (function(e) {
                      ...
                      return (
                        e instanceof Blob || Ce(e)
                          ? (t[0] = e.name || Ue())
                          : Ce(e)
                          ? ((t[1] = e.length), (t[2] = Fe(e)))
                          : G(e) &&
                            ((t[0] = Ne(e)),
                            (t[1] = 0),
                    ...
                    n.on("meta", function(t) {
                      (i.file.size = t.size),
                        ...
                        t.source &&
                          ...
                          (i.status = le.PROCESSING_COMPLETE)),
                        l("load-meta");
                    }),
                    n.on("progress", function(e) {
                      s(le.LOADING), l("load-progress", e);
                    }),
                    n.on("error", function(e) {
                      s(le.LOAD_ERROR), l("load-request-error", e);
                    }),
                    n.on("abort", function() {
                      s(le.INIT), l("load-abort");
                    }),
                    n.on("load", function(t) {
                      i.activeLoader = null;
                      var n = function(t) {
                        (i.file = tt(t) ? t : i.file),
                          e === ce.LIMBO && i.serverFileReference
                            ? s(le.PROCESSING_COMPLETE)
                            : s(le.IDLE),
                          l("load");
                      };
    ...
    ot = function(e, t, n, r, o, i) {
      var a = ze(null, e, { method: "GET", responseType: "blob" });
      return (
        (a.onload = function(n) {
          var r = n.getAllResponseHeaders(),
            o = He(r).name || Ne(e);
          t(ke("load", n.status, Be(n.response, o), r));
        }),
        (a.onerror = function(e) {
          n(ke("error", e.status, e.statusText, e.getAllResponseHeaders()));
        }),
    ...
    ut = function(e, t) {
      clearTimeout(t.listUpdateTimeout),
        (t.listUpdateTimeout = setTimeout(function() {
          e("DID_UPDATE_ITEMS", { items: he(t.items) });
        }, 0));
    },
    st = function(e) {
      for (
    ...
    ct = function(e, t) {
      return function() {
        ...
        s
          ? t(s, i, u)
          : u({ error: ke("error", 0, "Item not found"), file: null });
      };
    },
    ft = function(e, t, n) {
      return {
        ABORT_ALL: function() {
          he(n.items).forEach(function(e) {
          ...
          i.forEach(function(t) {
            ...
            o.forEach(function(t, n) {
              i.find(function(e) {
                ...
                e(
                  "ADD_ITEM",
                  Object.assign({}, t, { interactionMethod: ne, index: n })
                );
            });
        },
          ...
          clearTimeout(n.itemUpdateTimeout),
            (n.itemUpdateTimeout = setTimeout(function() {
              ...
              if (t("IS_ASYNC")) {
                ...
                return r.status === le.PROCESSING_COMPLETE
                  ? ((i = n.options.instantUpload),
                    void r
                      .revert(
                        $e(n.options.server.url, n.options.server.revert),
                        t("GET_FORCE_REVERT")
                      )
                      .then(i ? a : function() {})
                      .catch(function() {}))
                  : r.status === le.PROCESSING
                  ? (function(e) {
                      r.abortProcessing().then(e ? a : function() {});
                    })(n.options.instantUpload)
                  : void (n.options.instantUpload && a());
              }
              _e("SHOULD_PREPARE_OUTPUT", !1, { item: r, query: t }).then(
                function(t) {
                  t &&
                    e(
        ...
        ADD_ITEMS: function(n) {
          ...
          var d = t("GET_IGNORED_FILES"),
            E = r
              .filter(function(e) {
                return tt(e) ? !d.includes(e.name.toLowerCase()) : !P(e);
              })
              .map(function(t) {
                return new Promise(function(n, r) {
                  e("ADD_ITEM", {
        ...
        ADD_ITEM: function(r) {
          var o = r.source,
            ...
            p = r.options,
            d = void 0 === p ? {} : p;
          if (P(o)) f({ error: ke("error", 0, "No source"), file: null });
          else if (
            !tt(o) ||
            ...
            if (
              ...
              var _ = he(n.items)[0];
              if (
                _.status === le.PROCESSING_COMPLETE ||
                _.status === le.PROCESSING_REVERT_ERROR
              ) {
            ...
            var I =
                "local" === d.type
                  ...
                  ? ce.LIMBO
                  : ce.INPUT,
              m = nt(I, I === ce.INPUT ? null : o, d.file);
            Object.keys(d.metadata || {}).forEach(function(e) {
              m.setMetadata(e, d.metadata[e]);
            }),
              Te("DID_CREATE_ITEM", m, { query: t, dispatch: e });
            var v = t("GET_ITEM_INSERT_LOCATION");
            n.options.itemInsertLocationFreedom ||
              (a = "before" === v ? -1 : n.items.length),
              Me(n.items, m, a),
              x(v) && o && lt(n, v);
            var g = m.id;
            m.on("load-init", function() {
              e("DID_START_ITEM_LOAD", { id: g });
            }),
              m.on("load-meta", function() {
                e("DID_UPDATE_ITEM_META", { id: g });
              }),
              m.on("load-progress", function(t) {
                e("DID_UPDATE_ITEM_LOAD_PROGRESS", { id: g, progress: t });
              }),
              m.on("load-request-error", function(t) {
                var r = at(n.options.labelFileLoadError)(t);
              ...
              m.on("load-file-error", function(t) {
                e("DID_THROW_ITEM_INVALID", {
                  id: g,
                  error: t.status,
                  status: t.status
                }),
                  f({ error: t.status, file: se(m) });
              }),
              m.on("load-abort", function() {
                e("REMOVE_ITEM", { query: g });
              }),
              m.on("load-skip", function() {
              ...
              m.on("load", function() {
                var r = function(r) {
                  r
                    ? (m.on("metadata-update", function(t) {
                ...
                _e("DID_LOAD_ITEM", m, { query: t, dispatch: e })
                  .then(function() {
                    st(t("GET_BEFORE_ADD_FILE"), se(m)).then(r);
                  })
                  .catch(function() {
                    r(!1);
                  });
              }),
              m.on("process-start", function() {
                e("DID_START_ITEM_PROCESSING", { id: g });
              }),
              m.on("process-progress", function(t) {
                e("DID_UPDATE_ITEM_PROCESS_PROGRESS", { id: g, progress: t });
              }),
              m.on("process-error", function(t) {
                e("DID_THROW_ITEM_PROCESSING_ERROR", {
                  id: g,
                  error: t,
                  status: {
                    main: at(n.options.labelFileProcessingError)(t),
                    sub: n.options.labelTapToRetry
                  }
                });
              }),
              m.on("process-revert-error", function(t) {
                e("DID_THROW_ITEM_PROCESSING_REVERT_ERROR", {
                  id: g,
                  error: t,
                  status: {
                    main: at(n.options.labelFileProcessingRevertError)(t),
                    sub: n.options.labelTapToRetry
                  }
                });
              }),
              m.on("process-complete", function(t) {
        ...
        REQUEST_PREPARE_OUTPUT: function(e) {
          var n = e.item,
            r = e.ready;
          n.archived ||
            _e("PREPARE_OUTPUT", n.file, { query: t, item: n }).then(function(
              e
            ) {
              _e("COMPLETE_PREPARE_OUTPUT", e, { query: t, item: n }).then(
                function(e) {
                  n.archived || r(e);
                }
              );
        ...
        COMPLETE_LOAD_ITEM: function(r) {
          ...
          x(s) && u && lt(n, s),
            e("DID_LOAD_ITEM", {
              id: o.id,
              error: null,
              serverFileReference: o.origin === ce.INPUT ? null : u
            }),
            a(se(o)),
            o.origin !== ce.LOCAL
              ? o.origin !== ce.LIMBO
        ...
        RETRY_ITEM_LOAD: ct(n, function(e) {
          e.retryLoad();
        }),
        REQUEST_ITEM_PROCESSING: ct(n, function(r, o, i) {
          if (r.status === le.IDLE || r.status === le.PROCESSING_ERROR)
            r.status !== le.PROCESSING_QUEUED &&
              (r.requestProcessing(),
            ...
            r.status === le.PROCESSING_COMPLETE ||
            r.status === le.PROCESSING_REVERT_ERROR
              ? r
                  .revert(
                    $e(n.options.server.url, n.options.server.revert),
                    t("GET_FORCE_REVERT")
                  ...
                  .then(a)
                  .catch(function() {})
              : r.status === le.PROCESSING && r.abortProcessing().then(a);
          }
        }),
        PROCESS_ITEM: ct(n, function(r, o, i) {
                    ...
                    (function() {
                      ...
                      return "function" == typeof t
                        ...
                        ? function(r, o, i, a, u, s) {
                            ...
                            if (r) {
                              var p = new FormData();
                              H(o) && p.append(n, JSON.stringify(o)),
                                (r instanceof Blob
                                  ? [{ name: null, file: r }]
                                  : r
                                ).forEach(function(e) {
                      ...
                      n.options.server.process,
                      n.options.name
                    )
                  ),
                  function(n, o, i) {
                    _e("PREPARE_OUTPUT", n, { query: t, item: r })
                      .then(function(t) {
        ...
        RETRY_ITEM_PROCESSING: ct(n, function(t) {
          e("REQUEST_ITEM_PROCESSING", { query: t });
        }),
        REQUEST_REMOVE_ITEM: ct(n, function(n) {
          st(t("GET_BEFORE_REMOVE_FILE"), se(n)).then(function(t) {
            t && e("REMOVE_ITEM", { query: n });
          });
        }),
        RELEASE_ITEM: ct(n, function(e) {
          e.release();
        }),
        REMOVE_ITEM: ct(n, function(t, r) {
          var o = function() {
              var o = t.id;
              rt(n.items, o).archive(),
                e("DID_REMOVE_ITEM", { error: null, id: o, item: t }),
                ut(e, n),
                r(se(t));
            },
            i = n.options.server;
          t.origin === ce.LOCAL && i && x(i.remove)
              ...
              i.remove(
                ...
                function(r) {
                  e("DID_THROW_ITEM_REMOVE_ERROR", {
                    id: t.id,
                    error: ke("error", 0, r, null),
                    status: {
                      main: at(n.options.labelFileRemoveError)(r),
                      sub: n.options.labelTapToRetry
                    }
                  });
                }
        ...
        ABORT_ITEM_LOAD: ct(n, function(e) {
          e.abortLoad();
        }),
        ABORT_ITEM_PROCESSING: ct(n, function(t) {
          t.serverId
        ...
        REQUEST_REVERT_ITEM_PROCESSING: ct(n, function(r) {
        ...
        REVERT_ITEM_PROCESSING: ct(n, function(r) {
          r.revert(
            $e(n.options.server.url, n.options.server.revert),
            t("GET_FORCE_REVERT")
          )
        ...
        SET_OPTIONS: function(t) {
          var n = t.options;
          r(n, function(t, n) {
            e("SET_" + Q(t, "_").toUpperCase(), { value: n });
          });
        }
      };
    },
    ...
    It = y({
      ...
      write: function(e) {
        ...
        if (0 !== n.opacity) {
          ...
          var s = Tt(o, o, o - r, a, u);
          i(t.ref.path, "d", s),
            i(t.ref.path, "stroke-opacity", n.spin || n.progress > 0 ? 1 : 0);
        }
      },
      mixins: {
    ...
    mt = y({
      ...
      write: function(e) {
        ...
        o && !r
          ? ((n.isDisabled = !0), i(t.element, "disabled", "disabled"))
          : !o &&
            r &&
    ...
    Dt = function(e) {
      var t = e.root,
        n = e.props;
      Et(t.ref.fileSize, vt(t.query("GET_ITEM_SIZE", n.id))),
        Et(t.ref.fileName, pt(t.query("GET_ITEM_NAME", n.id)));
    },
    yt = function(e) {
      var t = e.root,
        n = e.props;
      F(t.query("GET_ITEM_SIZE", n.id)) ||
        Et(t.ref.fileSize, t.query("GET_LABEL_FILE_SIZE_NOT_AVAILABLE"));
    },
    St = y({
      name: "file-info",
      ignoreRect: !0,
      ...
      didCreateView: function(e) {
        Te("CREATE_VIEW", Object.assign({}, e, { view: e }));
      },
      create: function(e) {
        var t = e.root,
          n = e.props,
        ...
        (o.className = "filepond--file-info-sub"),
          t.appendChild(o),
          (t.ref.fileSize = o),
          Et(o, t.query("GET_LABEL_FILE_WAITING_FOR_SIZE")),
          Et(r, pt(t.query("GET_ITEM_NAME", n.id)));
      },
      mixins: {
      ...
      var t = e.root,
        ...
        r =
          null === n.progress
            ...
            : t.query("GET_LABEL_FILE_LOADING") + " " + At(n.progress) + "%";
      Et(t.ref.main, r), Et(t.ref.sub, t.query("GET_LABEL_TAP_TO_CANCEL"));
    },
    Lt = function(e) {
      var t = e.root;
      Et(t.ref.main, ""), Et(t.ref.sub, "");
    },
    Pt = function(e) {
      var t = e.root,
        n = e.action;
      Et(t.ref.main, n.status.main), Et(t.ref.sub, n.status.sub);
    },
    Mt = y({
      name: "file-status",
      ignoreRect: !0,
      ...
      write: S({
        DID_LOAD_ITEM: Lt,
        DID_REVERT_ITEM_PROCESSING: Lt,
        DID_REQUEST_ITEM_PROCESSING: function(e) {
          var t = e.root;
          Et(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING")),
            Et(t.ref.sub, t.query("GET_LABEL_TAP_TO_CANCEL"));
        },
        DID_ABORT_ITEM_PROCESSING: function(e) {
          var t = e.root;
          Et(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING_ABORTED")),
            Et(t.ref.sub, t.query("GET_LABEL_TAP_TO_RETRY"));
        },
        DID_COMPLETE_ITEM_PROCESSING: function(e) {
          var t = e.root;
          Et(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING_COMPLETE")),
            Et(t.ref.sub, t.query("GET_LABEL_TAP_TO_UNDO"));
        },
      ...
      create: function(e) {
        ...
        (r.className = "filepond--file-status-sub"),
          t.appendChild(r),
          (t.ref.sub = r),
          bt({ root: t, action: { progress: null } });
      },
      mixins: {
  ...
  var wt,
    ...
    Yt = {
      ...
      DID_START_ITEM_PROCESSING: xt,
      DID_REQUEST_ITEM_PROCESSING: xt,
      DID_UPDATE_ITEM_PROCESS_PROGRESS: xt,
    ...
    Xt = y({
      create: function(e) {
        ...
        if (a && !o) {
          u.splice(-1, 1);
          var s = Yt.DID_COMPLETE_ITEM_PROCESSING;
          (s.info.translateX = Bt),
            (s.info.translateY = Ut),
            (s.status.translateY = Ut),
        ...
        i &&
          o &&
          ((Ct.RevertItemProcessing.label = "GET_LABEL_BUTTON_REMOVE_ITEM"),
          (Ct.RevertItemProcessing.icon = "GET_ICON_REMOVE")),
          r(Ct, function(e, r) {
            var o = t.createChildView(mt, {
              label: t.query(r.label),
              icon: t.query(r.icon),
              opacity: 0
            });
            u.includes(e) && t.appendChildView(o),
              (o.element.dataset.align = t.query("GET_STYLE_" + r.align)),
              o.element.classList.add(r.className),
              o.on("click", function(e) {
                e.stopPropagation(), t.dispatch(r.action, { query: n });
              }),
              (t.ref["button" + e] = o);
          }),
          (t.ref.info = t.appendChildView(t.createChildView(St, { id: n }))),
          (t.ref.status = t.appendChildView(t.createChildView(Mt, { id: n }))),
          (t.ref.processingCompleteIndicator = t.appendChildView(
            t.createChildView(jt)
          )),
          (t.ref.processingCompleteIndicator.element.dataset.align = t.query(
            "GET_STYLE_BUTTON_PROCESS_ITEM_POSITION"
          ));
        var l = t.appendChildView(
          t.createChildView(It, {
            opacity: 0,
            align: t.query("GET_STYLE_LOAD_INDICATOR_POSITION")
          })
        );
        l.element.classList.add("filepond--load-indicator"),
          (t.ref.loadProgressIndicator = l);
        var c = t.appendChildView(
          t.createChildView(It, {
            opacity: 0,
            align: t.query("GET_STYLE_PROGRESS_INDICATOR_POSITION")
          })
        );
        c.element.classList.add("filepond--process-indicator"),
          (t.ref.processProgressIndicator = c),
          (t.ref.activeStyles = []);
      },
      write: function(e) {
        var t = e.root,
    ...
    Wt = y({
      create: function(e) {
        var t = e.root,
          n = e.props;
        (t.ref.fileName = dt("legend")),
          t.appendChild(t.ref.fileName),
          (t.ref.file = t.appendChildView(t.createChildView(Xt, { id: n.id })));
        var r = dt("input");
        (r.type = "hidden"),
      ...
      write: S({
        ...
        DID_LOAD_ITEM: function(e) {
          ...
          (t.ref.data.value = n.serverFileReference),
            Et(t.ref.fileName, pt(t.query("GET_ITEM_NAME", r.id)));
        },
    ...
    zt = { type: "spring", damping: 0.6, mass: 7 },
    kt = function(e, t, n) {
      var r = y({
      ...
      create: function(e) {
        ...
        [
          ...
          },
          {
            ...
            mixins: { animations: { translateY: zt }, styles: ["translateY"] }
          }
        ].forEach(function(e) {
          kt(t, e, n.name);
        }),
    ...
    Zt = { type: "spring", stiffness: 0.75, damping: 0.45, mass: 10 },
    $t = {
      ...
      create: function(e) {
        ...
        (t.ref.handleClick = function() {
          ...
          (t.ref.container = t.appendChildView(
            t.createChildView(Wt, { id: n.id })
          )),
          (t.ref.panel = t.appendChildView(
            t.createChildView(Qt, { name: "item-panel" })
          )),
    ...
    en = function(e, t) {
      if (t) {
        ...
        if (1 === l) {
          for (var c = 0; c < o; c++) {
            var f = r[c],
              p = f.rect.outer.top + 0.5 * f.rect.element.height;
            if (t.top < p) return c;
          }
          return o;
        }
        for (
          var d = a.marginTop + a.marginBottom, E = a.height + d, _ = 0;
          _ < o;
          _++
        ) {
          var T = (_ % l) * s,
    ...
    un = y({
      create: function(e) {
        var t = e.root,
          n = e.props;
        (t.ref.list = t.appendChildView(t.createChildView(on))),
    ...
    cn = function(e) {
      ...
      t.query("GET_TOTAL_ITEMS") > 0
        ? (sn(n, "required", !1), sn(n, "name", !1))
        : (sn(n, "name", !0, t.query("GET_NAME")),
          t.query("GET_CHECK_VALIDITY") && n.setCustomValidity(""),
          t.query("GET_REQUIRED") && sn(n, "required", !0));
    },
    fn = y({
      tag: "input",
      name: "browser",
      ...
      create: function(e) {
        ...
        (t.element.id = "filepond--browser-" + n.id),
          i(t.element, "name", t.query("GET_NAME")),
          i(t.element, "aria-controls", "filepond--assistant-" + n.id),
          i(t.element, "aria-labelledby", "filepond--drop-label-" + n.id),
      ...
      write: S({
        ...
        DID_SET_REQUIRED: function(e) {
          var t = e.root;
          e.action.value
            ? 0 === t.query("GET_TOTAL_ITEMS") && sn(t.element, "required", !0)
            : sn(t.element, "required", !1);
        }
      })
    }),
    pn = 13,
    ...
    _n = y({
      ...
      create: function(e) {
        var t = e.root,
          n = e.props,
          r = dt("label");
        i(r, "for", "filepond--browser-" + n.id),
          i(r, "id", "filepond--drop-label-" + n.id),
          i(r, "aria-hidden", "true"),
          r.addEventListener("keydown", function(e) {
            (e.keyCode === pn || e.keyCode === dn) &&
    ...
    gn = ["css", "csv", "html", "txt"],
    Rn = { zip: "zip|compressed", epub: "application/epub+zip" },
    hn = function() {
      var e =
        arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "";
      return (
    ...
    Sn = function(e) {
      return new Promise(function(t, n) {
        Ln(e) ? An(Mn(e)).then(t) : t([e.getAsFile()]);
      });
    },
    An = function(e) {
      return new Promise(function(t, n) {
        var r = [],
          o = 0;
        !(function e(n) {
          n.createReader().readEntries(function(n) {
            n.forEach(function(n) {
              n.isDirectory
                ? e(n)
                : (o++,
                  n.file(function(e) {
                    r.push(bn(e)), o === r.length && t(r);
                  }));
            });
          });
        })(e);
    ...
    bn = function(e) {
      ...
      var t = e.lastModifiedDate,
        n = e.name;
      return (
        ((e = e.slice(0, e.size, hn(we(e.name)))).name = n),
        (e.lastModifiedDate = t),
        e
      );
    },
    Ln = function(e) {
      return Pn(e) && (Mn(e) || {}).isDirectory;
    },
    Pn = function(e) {
    ...
    Vn = function(e) {
      var t = [],
        n = { dragenter: Yn, dragover: jn, dragleave: Xn, drop: Hn },
        o = {};
      r(n, function(n, r) {
        ...
        On(n).then(function(r) {
          ...
          t.some(function(t) {
            ...
            if (f)
              if (Fn(e, a)) {
                if (((o = !0), null === t.state))
                  return (t.state = "enter"), void u(Un(e));
                if (((t.state = "over"), i && !f)) return void xn(n, "none");
                l(Un(e));
              } else
                i && !o && xn(n, "none"),
                  t.state && ((t.state = null), s(Un(e)));
            else xn(n, "none");
          });
        });
      };
        ...
        On(n).then(function(n) {
          t.forEach(function(t) {
            var r = t.filterElement,
              ...
              a = t.onexit,
              u = t.allowdrop;
            (t.state = null), u(n) ? (r && !Fn(e, o)) || i(Un(e), n) : a(Un(e));
          });
        });
      };
    },
    ...
    kn = [],
    Qn = function(e) {
      On(e.clipboardData).then(function(e) {
        e.length &&
        ...
        t = {
          destroy: function() {
            ...
            (t = e),
              oe(kn, kn.indexOf(t)),
              0 === kn.length &&
                (document.removeEventListener("paste", Qn), (zn = !1));
          },
          onload: function() {}
        };
      return (
        (function(e) {
          kn.includes(e) ||
            (kn.push(e),
            zn || ((zn = !0), document.addEventListener("paste", Qn)));
        })(e),
        t
      );
    },
    ...
    or = function(e) {
      var t = e.root,
        n = e.action,
        r = t.query("GET_ITEM", n.id).filename;
      er(t, n.status.main + " " + r + " " + n.status.sub);
    },
    ir = y({
      create: function(e) {
        var t = e.root,
        ...
        (t.element.id = "filepond--assistant-" + n.id),
          i(t.element, "role", "status"),
          i(t.element, "aria-live", "polite"),
          i(t.element, "aria-relevant", "additions");
      },
      ignoreRect: !0,
      ignoreRectUpdate: !0,
      write: S({
          ...
          if (nr(t)) {
            ...
            Jn.push(r.filename),
              ...
              ($n = setTimeout(function() {
                tr(t, Jn.join(", "), t.query("GET_LABEL_FILE_ADDED")),
                  (Jn.length = 0);
              }, 750));
          }
        },
        DID_REMOVE_ITEM: function(e) {
          ...
          if (nr(t)) {
            var r = n.item;
            tr(t, r.filename, t.query("GET_LABEL_FILE_REMOVED"));
          }
        },
        DID_COMPLETE_ITEM_PROCESSING: function(e) {
          var t = e.root,
        ...
        DID_ABORT_ITEM_PROCESSING: rr,
        DID_REVERT_ITEM_PROCESSING: rr,
        DID_THROW_ITEM_REMOVE_ERROR: or,
        DID_THROW_ITEM_LOAD_ERROR: or,
        DID_THROW_ITEM_INVALID: or,
        DID_THROW_ITEM_PROCESSING_ERROR: or
      }),
      tag: "span",
      name: "assistant"
    }),
    ...
    lr = function(e) {
      var t = 0,
        ...
        o = r.childViews[0],
        i = o.childViews;
      if (0 === i.length) return { visual: t, bounds: n };
      var a = o.rect.element.width,
        u = en(o, r.dragCoordinates),
        s = i[0].rect.element,
        l = s.marginTop + s.marginBottom,
        c = s.marginLeft + s.marginRight,
        f = s.width + c,
        p = s.height + l,
        d = void 0 !== u && u >= 0 ? 1 : 0,
        E = i.find(function(e) {
    ...
    dr = function(e) {
      ...
      if (r && !e.ref.hopper) {
        var o = Wn(
          ...
          function(t) {
            ...
            return (
              ...
              t.every(function(t) {
                return (
                  Te("ALLOW_HOPPER_ITEM", t, { query: e.query }).every(function(
                    e
                  ) {
                    return !0 === e;
                  }) && n(t)
          ...
          },
          {
            filterItems: function(t) {
              ...
              return t.filter(function(e) {
                return !tt(e) || !n.includes(e.name.toLowerCase());
              });
            },
        ...
        (o.onload = function(t, n) {
          ...
          (e.ref.hopper = o),
          (e.ref.drip = e.appendChildView(e.createChildView(mn)));
      } else
        !r &&
          e.ref.hopper &&
      ...
      create: function(e) {
        ...
        o &&
          ...
          (t.ref.list = t.appendChildView(
            t.createChildView(un, { translateY: null })
          )),
          (t.ref.panel = t.appendChildView(
            t.createChildView(Qt, { name: "panel-root" })
          )),
          (t.ref.assistant = t.appendChildView(
            t.createChildView(ir, Object.assign({}, n))
          )),
          (t.ref.measure = dt("div")),
      ...
      write: function(e) {
        ...
        if (
          ...
          var c = t.query("GET_PANEL_ASPECT_RATIO"),
            ...
            d = p === (f ? t.query("GET_MAX_FILES") || 1e6 : 1),
            E = r.find(function(e) {
          ...
          if (d && E) {
            ...
            (u.opacity = 0),
              f
                ...
                : _ === K
                ? (u.translateX = 40)
                : (u.translateY = _ === ee ? 40 : 30);
          } else d || ((u.opacity = 1), (u.translateX = 0), (u.translateY = 0));
          var T = sr(t),
            I = lr(t),
            m = u.rect.element.height,
            v = !f || d ? 0 : m,
            g = d ? s.rect.element.marginTop : 0,
            R = 0 === p ? 0 : s.rect.element.marginBottom,
            h = v + g + I.visual + R,
            O = v + g + I.bounds + R;
          if (
            ((s.translateY = Math.max(0, v - s.rect.element.marginTop) - T.top),
            c)
          ) {
            ...
            if ((S.push(D), S.length > 4))
              for (var A = S.length, b = A - 10, L = 0, M = A; M >= b; M--)
                if ((S[M] === S[M - 2] && L++, L >= 2)) return;
            (l.scalable = !1), (l.height = y);
            var C = y - v - (R - T.bottom) - (d ? g : 0);
            I.visual > C ? (s.overflow = C) : (s.overflow = null),
              (t.height = y);
          } else if (o.fixedHeight) {
            l.scalable = !1;
            var N = o.fixedHeight - v - (R - T.bottom) - (d ? g : 0);
            I.visual > N ? (s.overflow = N) : (s.overflow = null);
          } else if (o.cappedHeight) {
            var w = h >= o.cappedHeight,
              G = Math.min(o.cappedHeight, h);
            (l.scalable = !0), (l.height = w ? G : G - T.top - T.bottom);
            var U = G - v - (R - T.bottom) - (d ? g : 0);
            h > o.cappedHeight && I.visual > U
              ? (s.overflow = U)
              : (s.overflow = null),
              (t.height = Math.min(o.cappedHeight, O - T.top - T.bottom));
          } else {
            var B = p > 0 ? T.top + T.bottom : 0;
            (l.scalable = !0),
              (l.height = Math.max(m, h - B)),
              (t.height = Math.max(m, O - B));
          }
        }
      },
      destroy: function(e) {
    ...
    mr = function() {
      ...
      var d = Ir(i, { id: re() }),
        ...
        I = {
          _read: function() {
            s &&
              ...
              T && _ && (_ = null === d.element.offsetParent),
              _ || (d._read(), (T = d.rect.element.hidden));
          },
          _write: function(e) {
            var t,
        ...
        m = function(e) {
          return function(t) {
            ...
            return (
              t.items && (n.items = t.items.map(se)),
                  ...
                  setTimeout(function() {
                    !(function(e) {
                      ...
                      Object.keys(e)
                        ...
                        y.fire.apply(y, [e.type].concat(n));
        ...
        R = function(e) {
          return (
            i.dispatch("REMOVE_ITEM", { query: e }),
        ...
        y = Object.assign(
            ...
            return (
              r(t, function(t) {
                n[t] = {
                  ...
                  set: function(n) {
                    e.dispatch("SET_" + Q(t, "_").toUpperCase(), { value: n });
                  }
                };
              }),
              n
          ...
          })(i, n),
          {
            ...
            addFile: function(e) {
              var t =
                arguments.length > 1 && void 0 !== arguments[1]
                  ...
                  : {};
              return new Promise(function(n, r) {
                h([{ source: e, options: t }], { index: t.index })
                  .then(function(e) {
                    return n(e && e[0]);
                  })
                  .catch(r);
            ...
            processFiles: function() {
              ...
              if (!r.length) {
                var o = O().filter(function(e) {
                  return (
                    !(e.status === le.IDLE && e.origin === ce.LOCAL) &&
                    e.status !== le.PROCESSING &&
                    e.status !== le.PROCESSING_COMPLETE &&
                    e.status !== le.PROCESSING_REVERT_ERROR
                  );
                });
            ...
            browse: function() {
              var e = d.element.querySelector("input[type=file]");
              e && e.click();
            },
            destroy: function() {
              y.fire("destroy", d.element),
            ...
            insertBefore: function(e) {
              return A(d.element, e);
            },
            insertAfter: function(e) {
              return b(d.element, e);
            },
            appendTo: function(e) {
              return e.appendChild(d.element);
            },
            replaceElement: function(e) {
              A(d.element, e), e.parentNode.removeChild(e), (t = e);
            },
      ...
      return i.dispatch("DID_INIT"), o(y);
    },
    vr = function() {
      var e =
          arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
    ...
    Rr = function() {
      return (arguments.length <= 0 ? void 0 : arguments[0]) instanceof
        ...
        : vr.apply(void 0, arguments);
    },
    hr = ["fire", "_read", "_write"],
    Or = function(e) {
      var t = {};
      return ae(e, t, hr), t;
    },
        ...
        var t,
          n = e({
            ...
            utils: {
              ...
              isString: G,
              isFile: tt,
              toNaturalFileSize: vt,
              replaceInString: Dr,
              getExtensionFromFilename: we,
              getFilenameWithoutExtension: et,
              guesstimateMimeType: hn,
              getFileFromBlob: Be,
              ...
              applyFilterChain: _e,
              text: Et,
              getNumericAspectRatioFromString: Re
            },
            views: { fileActionButton: mt }
          });
        (t = n.options), Object.assign(ve, t);
      }
    },
    Mr = ((wt =
  ...
  if (
    ...
    "loading" !== document.readyState
      ...
      : document.addEventListener("DOMContentLoaded", wr);
    var Gr = function() {
      return r(me(), function(t, n) {
        e.OptionTypes[t] = n[1];
      });
    };
    (e.Status = Object.assign({}, Oe)),
      (e.FileOrigin = Object.assign({}, ce)),
      (e.FileStatus = Object.assign({}, le)),
      (e.OptionTypes = {}),
      Gr(),
      (e.create = function() {
        var t = Rr.apply(void 0, arguments);
        return t.on("destroy", e.destroy), Cr.apps.push(t), Or(t);
      }),
      (e.destroy = function(e) {
        var t = Cr.apps.findIndex(function(t) {
          return t.isAttachedTo(e);
        });
        return t >= 0 && (Cr.apps.splice(t, 1)[0].restoreElement(), !0);
      }),
      (e.parse = function(t) {
        return Array.from(t.querySelectorAll(".filepond"))
          .filter(function(e) {
            return !Cr.apps.find(function(t) {
              return t.isAttachedTo(e);
            });
          })
          .map(function(t) {
  ...
  (e.supported = Mr), Object.defineProperty(e, "__esModule", { value: !0 });
});
